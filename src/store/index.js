...
export default new Vuex.Store({
  state: {
    darkMode: true,
    projects: [
      {id: 0, img: 'https://firebasestorage.googleapis.com/v0/b/maven-34c28.appspot.com/o/Screen%20Shot%202021-03-26%20at%2010.14.43%20AM.png?alt=media&token=c8d2a34e-0514-4652-9895-137cfebb8d2b', name: 'Paktola', github: '', demo: '', description: 'Co-founded'},
      {id: 1, img: '', name: 'AirPass', github: 'https://github.com/RAAbbott/AirPass', demo: '', description: 'Co-founded'},
      ...
      {id: 6, img: '', name: 'Portfolio', github: 'https://github.com/RAAbbott/portfolio_v3', demo: 'https://admiring-sinoussi-2c958f.netlify.app'},
    ]
  },
  getters: {
