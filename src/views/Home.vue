<template>
  <div class="home h-auto w-screen">
    ...
    <Profile class="md:fixed md:left-1/2 md:top-1/2 transform -translate-x-1/2 ease-in-out duration-300 transition-opacity" :class="[min ? 'opacity-5 z-0 overflow-hidden' : '']"/>
